...
void mazeSolver :: displayWin()
{
    ...
    PlaySound("C:\\Users\\Hp-pc\\Desktop\\DS Project\\win.wav",NULL,SND_ASYNC);
...
void mazeSolver :: displayLost()
{
    ...
    PlaySound("C:\\Users\\Hp-pc\\Desktop\\DS Project\\lose.wav",NULL,SND_ASYNC);
...
bool mazeSolver :: solvable(int row, int col, string direc)
{
    ...
    if(isSafe(row,col))
    {
        PlaySound("C:\\Users\\Hp-pc\\Desktop\\DS Project\\step.wav",NULL,SND_ASYNC);
        no_of_steps++;
